...
define(['./util'], function(util) {
	 ...
	 */
	p.observe = function(object, paths) {
	 ...
	 * @return  {Object}
	 */
	p.getCache = function(object, property) {
	 ...
	 * @param  {String}  property  [属性名称]
	 */
	p.setCache = function(object, value, property) {
	 ...
	 * @param   {Array}         paths   [访问路径数组]
	 */
	p.bindWatching = function(object, paths) {
	 ...
	 * @param   {Array}  paths  [访问路径数组]
	 */
	p.rewriteArrayMethods = function(array, paths) {
	 ...
	 */
	p.triggerChange = function(path, last, old) {
