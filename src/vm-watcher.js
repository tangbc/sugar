...
define([
	 ...
	 */
	p.add = function(field, callback, context, args) {
	 ...
	 * @param   {Mix}     old   [旧值]
	 */
	p.triggerAgent = function(path, last, old) {
	 ...
	 * @param  {Array}     args      [回调参数]
	 */
	p.watchAccess = function(access, callback, context, args) {
	 ...
	 * @param   {Mix}     old     [旧值]
	 */
	p.triggerAccess = function(access, last, old) {
		var callbacks = this.$accessCallbacks;
	 ...
	 * @param  {Object}    context   [作用域]
	 */
	p.watcherIndex = function(access, callback, context) {
	 ...
	 */
	p.backwardArray = function(field) {
	 ...
	 */
	p.updateArrayAccess = function(field, backward) {
		var prefix = field + '*';
	 ...
	 */
	p.displaceCallback = function(prefix, backward) {
		var callbacks = this.$accessCallbacks;
	 ...
	 * @param   {Boolean}  backward
	 */
	p.displaceIndex = function(prefix, backward) {
